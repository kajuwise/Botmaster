...
char* StateHolder::toString() const
{
    switch (m_state)
    {
        ...
        case Neve::FIND_GOAL: return "FIND_GOAL"; //4
        case Neve::GOAL_RANDOM: return "GOAL_RANDOM";
        case Neve::BALL_RANDOM: return "BALL_RANDOM";
        case Neve::NEW_KICK_POSITION: return "NEW_KICK_POSITION";
